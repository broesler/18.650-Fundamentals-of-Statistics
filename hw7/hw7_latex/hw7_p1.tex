...
\begin{prop}
  A $t$-distribution with $\nu$ degrees of freedrom approaches a standard normal
...
\emph{Proof.}
  ...
  Then, the $t$-distribution is exactly described in terms of the sample
  \begin{align*}
    t_{n-1} &= \ddfrac{Z}{\sqrt{\frac{V}{n-1}}}  \\
            &= \frac{\sqrt{n}(\Xnbar - \mu)}{S_n}.
  \end{align*}
...
Since $Z \Dlim \N{0}{1}$, Slutsky's theorem implies that
\begin{align*}
  t_{n-1} = \ddfrac{Z}{\sqrt{\frac{V}{\nu}}} 
