...
\begin{proof}
  ...
  \end{align*}
  By subtracting $\E{X} \times \text{\Cref{eq:EA}}$ from \Cref{eq:EB}, we get
...
% Appendix: general hypothesis testing under normality assumption?
% Appendix: proof of F_{1, n} = t_n^2
% \begin{lemma}
%   Let $G \in \R^{k \times p}$ be a matrix with $\rank G = k \le p$.
%   \[ G\Bvh - G\Bv \sim \N{0}{\sigma^2 G^\T (\Xm^\T \Xm)^{-1} G}. \]
% \end{lemma}
